...
function formatPeriodLabel(period: number): string {
  if (period === -1) return 'Текущий мес.';
  if (period === 0) return 'За всё время';
  if (period === 1) return '1 мес.';
  return `${period} мес.`;
}
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <option value={-1} style={{ backgroundColor: 'var(--theme-input-bg)', color: 'var(--theme-input-text)' }}>Текущий месяц</option>
      ...
      <StatCardGrid columns={4}>
        ...
        <StatCard
          ...
          subtitle={`За ${formatPeriodLabel(period)}`}
          icon={UserCheck}
          color="emerald"
          loading={loading}
        />
        <StatCard
          ...
          subtitle={`Платежей: ${analytics?.revenue?.payments_count ?? 0}`}
          icon={DollarSign}
          color="violet"
          loading={loading}
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <ChartCard
          title={<>Динамика выручки <Help content="<b>Динамика выручки</b><br/><br/>График показывает сумму поступлений (платежей).<br/><br/>Детализация: текущий месяц или 1 месяц — по дням, остальные периоды — по месяцам.<br/><br/>Пунктирная линия показывает средний уровень выручки за период." /></>}
          subtitle={
            revenueGranularity === 'day' ? 'По дням' :
            period === 0 ? 'По месяцам (всё время)' : `По месяцам (${formatPeriodLabel(period)})`
          }
          icon={TrendingUp}
        ...
        <ChartCard
          title={<>Списании (нетто) <Help content="<b>Списании (нетто)</b><br/><br/>Сумма фактических списаний с денежного баланса клиентов за услуги (без учёта бонусов).<br/><br/><b>Нетто</b> = Стоимость услуг - Оплачено бонусами<br/><br/>Детализация: текущий месяц или 1 месяц — по дням, остальные периоды — по месяцам." /></>}
          subtitle={
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <ChartCard
          title={<>Топ партнёров <Help content="<b>Топ партнёров</b><br/><br/>Топ-10 партнёров по заработанным бонусам.<br/><br/>Показывает самых активных партнёров по реферальной программе.<br/><br/><b>Рефералов</b> — сколько пользователей привёл партнёр<br/><b>Платящих</b> — сколько из них платят<br/><b>Заработано</b> — общая сумма заработанных бонусов<br/><b>Оборот рефералов</b> — общая сумма платежей привлечённых клиентов" /></>}
          subtitle="По заработанным бонусам"
          icon={Star}
          iconColor="text-amber-400"
          loading={loading}
        >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs" style={{ color: 'var(--theme-content-text-muted)' }}>
                      {partner.referrals_count} рефералов · {partner.paying_referrals} платящих
                    </p>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-xs" style={{ color: 'var(--theme-content-text-muted)' }}>
                    Оборот рефералов: {formatMoney(partner.referrals_revenue)}
                  </p>
                </div>
              </div>
            )) || (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        ...
        <div className="card p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-semibold" style={{ color: 'var(--theme-content-text)' }}>🎁 Бонусная нагрузка</span>
            <Help content="<b>Реальная бонусная нагрузка</b><br/><br/>Доля использованных бонусов от общего оборота.<br/><br/><b>Формула:</b> Использованные бонусы / Общий оборот × 100%<br/><br/>Показывает, какую часть выручки компания «теряет» на бонусах. Например, 4.3% означает, что из каждых 100₽ выручки 4.30₽ были оплачены бонусами." />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between">
        ...
        <div className="card p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-semibold" style={{ color: 'var(--theme-content-text)' }}>⚠️ Бонусный долг</span>
            <Help content="<b>Текущий бонусный долг</b><br/><br/>Разница между начисленными и использованными бонусами.<br/><br/><b>Формула:</b> Начисленные бонусы - Использованные бонусы<br/><br/><b>Доля долга</b> — процент бонусного долга от оборота. Показывает потенциальные обязательства компании перед партнерами." />
          </div>
          <div className="space-y-2">
            <div className="flex justify-between">
